...
import NotifService from './notify/NotifService';
    ...
    return (
      <View style={styles.container}>
        ...
        <TouchableOpacity
          style={styles.button}
          onPress={() => {
            console.log('Local Notification (now)');
        ...
        <TouchableOpacity
          style={styles.button}
          onPress={() => {
            console.log("Local Notification with sound (now)");
        ...
        <TouchableOpacity
          style={styles.button}
          onPress={() => {
            console.log('Schedule Notification in 30s');
        ...
        <TouchableOpacity
          style={styles.button}
          onPress={() => {
            console.log('Schedule Notification with sound in 30s');
        ...
        <TouchableOpacity
          style={styles.button}
          onPress={() => {
            console.log('Cancel last notification (if any)');
